...
$(document).ready(function(){
    ...
    console.log(Object.isPrototypeOf(customerB)); //whydoesthisreturnfalse?
//whatistheprototypeofthecustomerBthen?
    console.log(Customer.isPrototypeOf(customerC));
//whydoesitreturnfalse?WhatistheprototypeofcustomerBthen?
});
